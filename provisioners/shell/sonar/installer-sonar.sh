...
sudo cp /vagrant/provisioners/shell/sonar/sonar.properties /etc/sonarqube/conf/sonar.properties
sudo rm /etc/sonar-runner/conf/sonar-runner.properties
sudo cp /vagrant/provisioners/shell/sonar/sonar-runner.properties /etc/sonar-runner/conf/sonar-runner.properties
